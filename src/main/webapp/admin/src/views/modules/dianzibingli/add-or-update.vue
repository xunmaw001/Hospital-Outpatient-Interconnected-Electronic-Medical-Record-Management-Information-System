<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="病例编号" prop="binglibianhao">
            <el-input v-model="ruleForm.binglibianhao" 
                placeholder="病例编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.binglibianhao" label="病例编号" prop="binglibianhao">
              <el-input v-model="ruleForm.binglibianhao" 
                placeholder="病例编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="制定时间" prop="zhidingshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.zhidingshijian" 
                type="date"
                :readonly="ro.zhidingshijian"
                placeholder="制定时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhidingshijian" label="制定时间" prop="zhidingshijian">
              <el-input v-model="ruleForm.zhidingshijian" 
                placeholder="制定时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="病情详述" prop="bingqingxiangshu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="病情详述"
                  v-model="ruleForm.bingqingxiangshu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.bingqingxiangshu" label="病情详述" prop="bingqingxiangshu">
                    <span>{{ruleForm.bingqingxiangshu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="检查诊断" prop="jianchazhenduan">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="检查诊断"
                  v-model="ruleForm.jianchazhenduan" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jianchazhenduan" label="检查诊断" prop="jianchazhenduan">
                    <span>{{ruleForm.jianchazhenduan}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="症状" prop="zhengzhuang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zhengzhuang" label="症状" prop="zhengzhuang">
                    <span>{{ruleForm.zhengzhuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      ro:{
	binglibianhao : false,
	bingqingxiangshu : false,
	jianchazhenduan : false,
	zhengzhuang : false,
  ...
  created() {
	this.ruleForm.zhidingshijian = this.getCurDate()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.binglibianhao = true;
          ...
          if(o=='bingqingxiangshu'){
            this.ruleForm.bingqingxiangshu = obj[o];
	    this.ro.bingqingxiangshu = true;
            continue;
          }
          if(o=='jianchazhenduan'){
            this.ruleForm.jianchazhenduan = obj[o];
	    this.ro.jianchazhenduan = true;
            continue;
          }
          if(o=='zhengzhuang'){
	    ...
	    this.ro.zhengzhuang = true;
          ...
          if(o=='zhidingshijian'){
            this.ruleForm.zhidingshijian = obj[o];
	    this.ro.zhidingshijian = true;
            continue;
          }
          if(o=='yishenggonghao'){
