<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="检查编号" prop="jianchabianhao">
            <el-input v-model="ruleForm.jianchabianhao" 
                placeholder="检查编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jianchabianhao" label="检查编号" prop="jianchabianhao">
              <el-input v-model="ruleForm.jianchabianhao" 
                placeholder="检查编号" readonly></el-input>
          </el-form-item>
        </div>
...
export default {
  ...
  created() {
	this.ruleForm.jianchashijian = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='jianchabianhao'){
            this.ruleForm.jianchabianhao = obj[o];
	    this.ro.jianchabianhao = true;
            continue;
          }
